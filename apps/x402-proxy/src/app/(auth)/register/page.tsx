...
const isGoogleEnabled = process.env.NEXT_PUBLIC_GOOGLE_OAUTH_ALLOWED === "true";
const isGithubEnabled = process.env.NEXT_PUBLIC_GITHUB_OAUTH_ALLOWED === "true";
...
export default function RegisterPage() {
  ...
  const getSlugStatusMessage = () => {
    switch (slugStatus) {
      ...
      default:
        return "This will be your unique URL identifier";
    }
  };
  ...
  return (
    <Card>
      <CardHeader className="text-center">
        ...
        <CardDescription>
          Start monetizing your APIs with crypto payments
        </CardDescription>
      </CardHeader>
        ...
        <div className="grid grid-cols-2 gap-3">
          <TooltipProvider>
            <Tooltip>
              ...
              {!isGoogleEnabled && (
                <TooltipContent>
                  <p>Google sign-up is not available in this environment.<br />GOOGLE_CLIENT_ID is not configured.</p>
                </TooltipContent>
              )}
            </Tooltip>
          </TooltipProvider>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <span className="w-full">
                  <Button
                    variant="outline"
                    disabled={isLoading || !isGithubEnabled}
                    className="w-full"
                    onClick={() => {
                      signIn.social({
                        provider: "github",
              ...
              {!isGithubEnabled && (
                <TooltipContent>
                  <p>GitHub sign-up is not available in this environment.<br />GITHUB_CLIENT_ID is not configured.</p>
                </TooltipContent>
              )}
            </Tooltip>
          </TooltipProvider>
